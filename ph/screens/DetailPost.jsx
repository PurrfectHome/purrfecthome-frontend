        ...
        <View>
          ...
          <View>
            <View style={tw`mx-5 mt-5 flex-row justify-between`}>
              ...
              <View>
                <Ionicons name="chatbubble-ellipses-outline" size={30} style={{ color: '#92aae2' }} />
              </View>
            </View>
            <View style={tw`mx-5 mt-5 flex-row justify-between`}>
            ...
            <View style={tw`mx-5 mt-5`}>
              <View style={tw`gap-2`}>
                ...
                <View style={tw`flex-row gap-1 items-center`}>
                  <View style={{ borderRadius: 7, backgroundColor: '#92aae2', padding: 5 }}>
                    <Text style={{ fontSize: 15, color: 'white' }}>
                      Without Adoption Fee
                    </Text>
                  </View>
                  <Ionicons name="pricetag" size={17} style={{ color: '#92aae2' }} />
                </View>
                {/* <View style={tw`flex-row gap-1 items-center`}>
